...
<head>
    ...
    <title>Portal Web - Tarea 5</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class personally identifiable information redacted><a class="nav-link active" href="index.php">Inicio</a></li>
    ...
    <div class="container mt-5 text-center">
        <h1>Bienvenido al Portal Web de: </h1>
        <h3> Carlos Castillo</h3>
        <img src="assests/passport.jpg" alt="Foto de pasaporte" class="img-fluid rounded-circle" style="max-width: 150px;">
        <p class="mt-3">Explora las diferentes funcionalidades a través del menú de navegación.</p>
    </div>
